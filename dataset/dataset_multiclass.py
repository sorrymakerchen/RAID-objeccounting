...
class MVTecDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        example["class_name"] = self.class_name
    ...
    def generate_anomaly(self, image):
        ...
        anomaly_source_paths = sorted(glob.glob("/home/ZYP/datasets/dtd/images" + "/*/*.jpg"))
    ...
    def transformer_compose(self, image, mask):
        transforms_resize = transforms.Resize((self.resize, self.resize), interpolation=transforms.InterpolationMode.BICUBIC, antialias=True)
        transforms_resize_mask = transforms.Resize((self.resize, self.resize), interpolation=transforms.InterpolationMode.BICUBIC, antialias=True)
        ...
        if mask:
            mask = transforms_resize_mask(mask)

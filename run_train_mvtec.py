...
from test_eval_mvtec import test_anomaly_detection
from sklearn.metrics import roc_auc_score

from src.utils import get_dataset_info
from src.detection_mvtec import run_anomaly_detection
...
def parse_args():
    ...
    parser.add_argument("--data_root", type=str, default="/home/ZYP/datasets/mvtec",
...
def train_anomaly_detection(
    ...
    for epoch in range(args.epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            for obj in objects:
                ...
                if knn_metric == "L2":
                    ...
                    if obj == "screw" or obj == "capsule" or obj == "cable" or obj == "wood":
        ...
        if epoch > 30:
            ...
            checkpoint_path = f"{checkpoint_dir}/checkpoint_epoch{epoch}_seed{seed}_150.pth"
